    ...
    return (
        <div className="min-h-screen bg-gray-900 p-6">
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                {/* Navigation Tabs */}
                <div className="bg-gray-800 border border-gray-700 rounded-xl p-2 mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="bg-gradient-to-br from-blue-900 to-blue-800 border border-blue-700 rounded-xl p-6">
                                <div className="flex items-center mb-4">
                                    ...
                                    <h3 className="text-xl font-bold text-white">LightGBM Optimizado</h3>
                                </div>
                                <p className="text-blue-200 mb-3 font-medium">Gradient Boosting Avanzado</p>
                            ...
                            <div className="bg-gradient-to-br from-green-900 to-green-800 border border-green-700 rounded-xl p-6">
                                ...
                                <p className="text-green-200 mb-3 font-medium">TimeSeriesSplit + Walk-Forward</p>
                            ...
                            <div className="bg-gradient-to-br from-purple-900 to-purple-800 border border-purple-700 rounded-xl p-6">
                                ...
                                <p className="text-purple-200 mb-3 font-medium">Técnico + Sentimiento + Contexto</p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                {democratizationImpact.map((item, index) => (
                                    <div key={index} className="bg-gray-700 rounded-lg p-4">
                                        <h4 className="text-white font-bold mb-3">{item.metric}</h4>
                                        <div className="space-y-3 text-sm">
                                            <div className="text-gray-300">
                                                <span className="text-gray-500">Antes:</span>
                                                <div className="text-orange-400 font-medium">{item.before}</div>
                                            </div>
                                            <div className="text-gray-300">
                                                <span className="text-gray-500">Ahora:</span>
                                                <div className="text-emerald-300 font-medium">{item.after}</div>
                                            </div>
                                            <div className="text-blue-300 font-medium border-t border-gray-600 pt-2">
                                                {item.improvement}
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="bg-gray-800 border border-gray-700 rounded-xl p-8">
                            ...
                            <div className="prose prose-gray max-w-none space-y-4">
                                <div className="bg-gray-700 rounded-lg p-6">
                                    <h3 className="text-cyan-400 text-xl font-bold mb-3">Hipótesis Central</h3>
                                ...
                                <div className="bg-gray-700 rounded-lg p-6">
                                    <h3 className="text-cyan-400 text-xl font-bold mb-3">Enfoque Multimodal</h3>
                                ...
                                <div className="bg-gray-700 rounded-lg p-6">
                                    <h3 className="text-cyan-400 text-xl font-bold mb-3">Selección de Modelo Óptimo</h3>
                                    <p className="text-gray-300 leading-relaxed mb-4">
                    ...
                    <div className="space-y-8">
                                    ...
                                    return (
                                        <div key={index} className="bg-gray-700 rounded-lg p-6">
                                            <div className="flex items-start">
                                                <IconComponent className={`w-8 h-8 ${finding.color} mr-4 flex-shrink-0`} />
                                                <div className="flex-1">
                                                    <h3 className="text-lg font-bold text-white mb-2">{finding.title}</h3>
                                                    <p className="text-blue-300 font-medium mb-2">{finding.description}</p>
                        ...
                        <div className="bg-yellow-900/30 border border-yellow-600 rounded-xl p-6">
                            <div className="flex items-start">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-yellow-400 mb-3">Limitaciones Reconocidas</h3>
                        ...
                        <div className="bg-gray-800 border border-gray-700 rounded-xl p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                {technicalSpecs.map((spec, index) => (
                                    <div key={index} className="bg-gray-700 rounded-lg p-4">
                                        <div className="text-orange-400 font-bold text-sm mb-1">{spec.label}</div>
                            ...
                            <div className="bg-gray-800 border border-gray-700 rounded-xl p-6">
                                ...
                                <div className="space-y-4">
                                    <div className="bg-gray-700 rounded-lg p-4">
                                        ...
                                        <p className="text-gray-300 text-xs mb-2">btc_nasdaq_beta_10d, btc_nasdaq_corr_5d</p>
                                    ...
                                    <div className="bg-gray-700 rounded-lg p-4">
                                        ...
                                        <p className="text-gray-300 text-xs mb-2">roc_1d, roc_3d</p>
                                    ...
                                    <div className="bg-gray-700 rounded-lg p-4">
                                        ...
                                        <p className="text-gray-300 text-xs mb-2">high_low_range, bb_width</p>
                            ...
                            <div className="bg-gray-800 border border-gray-700 rounded-xl p-6">
                                ...
                                <div className="space-y-4">
                                    <div className="bg-gray-700 rounded-lg p-4">
                                        ...
                                        <p className="text-gray-300 text-xs mb-2">sent_q5_flag (euforia), sent_q2_flag_x_close_to_sma10 (efecto contrario)</p>
                                    ...
                                    <div className="bg-gray-700 rounded-lg p-4">
                                        ...
                                        <p className="text-gray-300 text-xs mb-2">sent_5d, sent_accel, sent_vol</p>
                                    ...
                                    <div className="bg-gray-700 rounded-lg p-4">
                                        ...
                                        <p className="text-gray-300 text-xs mb-2">sent_cross_up_x_high_low_range, sent_neg_x_high_low_range</p>
                ...
                {activeTab === 'architecture' && (
                    <div className="space-y-8">
                            ...
                            <div className="space-y-4">
                                {architectureComponents.map((component, index) => (
                                    <div key={index} className="bg-gray-700 rounded-lg p-4 flex items-center justify-between">
                                        <div className="flex-1">
                                            <h4 className="text-blue-400 font-bold">{component.layer}</h4>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {[
                                    ...
                                    <div key={index} className="bg-gray-700 rounded-lg p-3">
                                        <div className="text-green-400 font-bold text-sm">{item.table}</div>
                        ...
                        <div className="bg-gray-800 border border-gray-700 rounded-xl p-6">
                            <h3 className="text-xl font-bold text-white mb-4 flex items-center">
                                <Monitor className="w-6 h-6 text-cyan-500 mr-2" />
                                ...
                                <div className="bg-gray-700 rounded-lg p-4">
                                    ...
                                    <div className="space-y-2 text-xs">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="bg-green-600 px-2 py-1 rounded font-bold">GET</span>
                                        </div>
                                        <div className="flex justify-between items-center">
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="bg-blue-600 px-2 py-1 rounded font-bold">POST</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-gray-700 rounded-lg p-4">
                                    ...
                                    <div className="space-y-2 text-xs">
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="bg-purple-600 px-2 py-1 rounded font-bold">WS</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="bg-gradient-to-r from-yellow-900/30 to-orange-900/30 border border-yellow-600 rounded-xl p-6">
                    <div className="flex items-start">
                        <AlertTriangle className="w-8 h-8 text-yellow-500 mr-4 flex-shrink-0 mt-1" />
                        <div>
                            <h3 className="text-xl font-bold text-yellow-400 mb-3">Declaración de Responsabilidad</h3>
                            <div className="space-y-3 text-yellow-100">
                                <p>
                            ...
                            <div className="mt-4 p-4 bg-yellow-800/50 rounded-lg">
                                <h4 className="text-yellow-300 font-bold mb-2">Uso Responsable Recomendado:</h4>
                ...
                <div className="bg-gray-800 border border-gray-700 rounded-xl p-8">
                    <div className="flex items-center mb-8">
                        ...
                        <h2 className="text-2xl font-bold text-white">Preguntas Frecuentes Técnicas</h2>
                    </div>
                    <p className="text-gray-400 text-lg mb-8">
                ...
                <div className="bg-gradient-to-r from-blue-900/50 to-purple-900/50 border border-blue-700 rounded-xl p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h3 className="text-blue-300 font-bold mb-3">Validadas Empíricamente</h3>
                        ...
                        <div>
                            <h3 className="text-purple-300 font-bold mb-3">Líneas Futuras</h3>
                            <ul className="space-y-2 text-gray-300 text-sm">
                ...
                {/* Footer con información del TFG */}
